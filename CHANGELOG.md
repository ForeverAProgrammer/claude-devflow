...
- Added `/create-pr-github-git` command to push the current branch and open or update a GitHub PR, deriving title and description from git history (this commit)
